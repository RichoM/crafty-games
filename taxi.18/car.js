Crafty.c("Car", {
	...
	init: function () {		
		this.addComponent("2D, Canvas, Bounds, Collision, Tween, CheckpointFollower")
			.attr({w: 33, h: 55})
			.origin(16, 40)
			...
			.bind("Checkpoint", this.hitCheckpoint);		
	},
	...
	hitCheckpoint: function (cp) {
		this.checkpoints++;
		if (this.checkpoints === cp.count()) {
			this.lap++;
			this.checkpoints = 0;
